...
use Vinelab\NeoEloquent\Console\Migrations\RefreshCommand;
...
class MigrationServiceProvider extends ServiceProvider {
    ...
    protected function registerRollbackCommand()
    {
        ...
        {
            return new RollbackCommand($app['neoeloquent.migrator']);
        });
    }
    ...
    protected function registerResetCommand()
    {
        ...
        {
            return new ResetCommand($app['neoeloquent.migrator']);
        });
    }
