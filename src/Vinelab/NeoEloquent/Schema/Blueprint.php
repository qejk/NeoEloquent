...
class Blueprint {
    ...
    public function dropUnique($properties)
    {
        ...
        {
            $this->indexCommand('dropUnique', $propertie);
        }
    }
    ...
    public function dropIndex($properties)
    {
        ...
        foreach ($properties as $propertie)
        {
            $this->indexCommand('dropIndex', $propertie);
        }
    }
    ...
    public function unique($properties)
    {
        ...
        foreach ($properties as $propertie)
        {
            $this->addCommand('unique', ['propertie' => $propertie]);
        }
    }
    ...
    public function index($properties)
    {
        ...
        foreach ($properties as $propertie)
        {
            $this->addCommand('index', ['propertie' => $propertie]);
        }
    }
     ...
     *
     * @param  string        $type
     * @param  string|array  $propertie
     * @param  string        $index
     * @return \Illuminate\Support\Fluent
     */
    protected function indexCommand($type, $propertie)
    {
        return $this->addCommand($type, compact('propertie'));
    }
