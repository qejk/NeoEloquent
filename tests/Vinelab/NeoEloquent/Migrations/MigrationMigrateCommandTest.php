...
class MigrationMigrateCommandTest extends TestCase
{
    ...
    public function testBasicMigrationsCallMigratorWithProperArguments()
    {
        ...
        $migrator->shouldReceive('run')->once()->with(__DIR__.'/database/labels', false);
    ...
    public function testMigrationRepositoryCreatedWhenNecessary()
    {
        ...
        $command = $this->getMock('Vinelab\NeoEloquent\Console\Migrations\MigrateCommand', array('call'), $params);
        $app = new ApplicationDatabaseMigrationStub(array('path' => __DIR__));
        $command->setLaravel($app);
        $migrator->shouldReceive('setConnection')->once()->with(null);
        $migrator->shouldReceive('run')->once()->with(__DIR__.'/database/labels', false);
    ...
    public function testPackageIsRespectedWhenMigrating()
    {
        ...
        $migrator->shouldReceive('setConnection')->once()->with(null);
        $migrator->shouldReceive('run')->once()->with(__DIR__.'/vendor/bar/src/labels', false);
        $migrator->shouldReceive('getNotes')->andReturn(array());
        $migrator->shouldReceive('repositoryExists')->once()->andReturn(true);
    ...
    public function testVendorPackageIsRespectedWhenMigrating()
    {
        ...
        $command->setLaravel(new ApplicationDatabaseMigrationStub());
        $migrator->shouldReceive('setConnection')->once()->with(null);
        $migrator->shouldReceive('run')->once()->with(__DIR__.'/vendor/foo/bar/src/labels', false);
        $migrator->shouldReceive('getNotes')->andReturn(array());
        $migrator->shouldReceive('repositoryExists')->once()->andReturn(true);
    ...
    public function testTheCommandMayBePretended()
    {
        ...
        $command->setLaravel($app);
        $migrator->shouldReceive('setConnection')->once()->with(null);
        $migrator->shouldReceive('run')->once()->with(__DIR__.'/database/labels', true);
        $migrator->shouldReceive('getNotes')->andReturn(array());
        $migrator->shouldReceive('repositoryExists')->once()->andReturn(true);
